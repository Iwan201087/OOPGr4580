...
public class ViewRus implements iGetView {
     ...
     */
    public Scanner in = new Scanner(System.in, "Cp866"); // альтернативная кодировка для русского языка
    ...
    public void printAllStudents(List<Student> students) {
        System.out.println("_________Вывод списка студентов___________");
        for (Student student : students) {
            System.out.println(student);
        }
        System.out.println("__________Конец списка__________");
    }
