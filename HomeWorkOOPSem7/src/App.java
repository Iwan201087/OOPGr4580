...
public class App {
    ...
    /**
     * Метод app, точка входа в приложение.
     * 
        ...
        while (choice != 4) {
            ...
            switch (choice) {
                case 1:
                    ...
                    calculator.setOperation(new DecoratorLog(OperationFactory.createOperation("сложение")));
                ...
                case 2:
                    ...
                    calculator.setOperation(new DecoratorLog(OperationFactory.createOperation("вычитание")));
                ...
                case 3:
                    ...
                    calculator.setOperation(new DecoratorLog(OperationFactory.createOperation("умножение")));
                ...
                case 4:
                    ...
                    calculator.setOperation(new DecoratorLog(OperationFactory.createOperation("деление")));
